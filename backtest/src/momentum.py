...
def run_momentum(
    ...
    analysis_start: str = "2016-01-01", 
    analysis_end: str = "2026-03-01",
    fetch_start: str = "2015-01-01", # default to 11 yrs ago
    file_suffix_param: str = "momentum",  # suffix gets appended to each csv file
    ...
    dataFileName = "historyData" + file_suffix_param + ".csv"
    ...
    dataFileName = "portfolioList" + file_suffix_param + ".csv"
    ...
    dataFileName = "backtestResults" + file_suffix_param + ".csv"
