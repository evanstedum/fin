"""
Papa7 backtest data generator

forked from backtestDaily.py

pulls last 7 days and exports 3 CSVs:
- historyData: momentum calcs for all tickers/dates
- portfolioList: top 3 tickers per day by Papa Avg
- backtestResults: bucket logic + rebalancing applied to portfolioList
...
analysis_start = (date.today() - timedelta(days=7)).isoformat()    # 7 days ago
